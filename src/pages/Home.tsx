    ...
    <>
      ...
      <div className="h-screen w-full overflow-y-scroll snap-y snap-mandatory transition-colors duration-300 scrollbar-hide">
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            <div className="animate-fade-in">
              ...
              <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-6">
                {/* Subscribe Form */}
                <div className="max-w-md bg-white/10 backdrop-blur-md rounded-xl p-4 shadow-2xl">
                ...
                <div className="text-center animate-bounce">
                  <div className="flex flex-col items-center space-y-2">
                    <p className="text-sm font-medium text-white/90 uppercase tracking-widest drop-shadow-lg">Scroll to Watch</p>
                    <div className="w-px h-12 bg-gradient-to-b from-violet-400 to-transparent"></div>
                    <div className="flex items-center space-x-2">
                      <Youtube className="h-5 w-5 text-violet-400 animate-pulse drop-shadow-lg" />
                      <span className="text-sm font-medium text-white/90 drop-shadow-lg">Shorts Feed</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="relative h-screen bg-black snap-start">
          ...
          <div className="sticky top-16 left-0 right-0 z-40 bg-gradient-to-r from-violet-900/90 via-purple-900/90 to-violet-900/90 backdrop-blur-md py-4 border-b border-violet-500/50">
            <div className="flex items-center justify-center gap-3">
              <Youtube className="h-8 w-8 text-violet-400" />
        ...
        {/* --- CTA Section --- */}
        <section className="h-screen bg-gradient-to-br from-violet-100 via-white to-yellow-100 dark:from-gray-900 dark:via-purple-900/30 dark:to-violet-900/20 text-gray-900 dark:text-white snap-start flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Sparkles className="h-16 w-16 mx-auto mb-6 text-violet-600 dark:text-violet-400" />
