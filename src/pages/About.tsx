  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-yellow-50 to-violet-100 dark:from-gray-900 dark:via-black dark:to-gray-900 pt-20 sm:pt-24 pb-12 sm:pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="flex flex-col justify-center space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-white/60 dark:bg-black/40 backdrop-blur-md p-4 sm:p-5 md:p-6 rounded-xl border border-violet-200/50 dark:border-gray-800/50">
                <Laugh className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-violet-500 mb-2 sm:mb-3" />
                <h3 className="font-bold text-gray-900 dark:text-white mb-1.5 sm:mb-2 text-sm sm:text-base">Comedy</h3>
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm">
                  Making people laugh every day
                </p>
              </div>
              <div className="bg-white/60 dark:bg-black/40 backdrop-blur-md p-4 sm:p-5 md:p-6 rounded-xl border border-violet-200/50 dark:border-gray-800/50">
                <Camera className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-violet-500 mb-2 sm:mb-3" />
                <h3 className="font-bold text-gray-900 dark:text-white mb-1.5 sm:mb-2 text-sm sm:text-base">Modelling</h3>
                <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm">
        ...
        <div className="bg-white/60 dark:bg-black/40 backdrop-blur-md rounded-2xl sm:rounded-3xl border border-violet-200/50 dark:border-gray-800/50 p-6 sm:p-8 md:p-10 lg:p-12 mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="inline-flex p-3 sm:p-4 bg-violet-100 dark:bg-violet-900/30 rounded-full mb-3 sm:mb-4">
                <Sparkles className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-violet-500" />
              </div>
            ...
            <div className="text-center">
              <div className="inline-flex p-3 sm:p-4 bg-violet-100 dark:bg-violet-900/30 rounded-full mb-3 sm:mb-4">
                <Target className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-violet-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-3">
            ...
            <div className="text-center">
              <div className="inline-flex p-3 sm:p-4 bg-violet-100 dark:bg-violet-900/30 rounded-full mb-3 sm:mb-4">
                <Heart className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-violet-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-3">
                Community Building
              </h3>
        ...
        <div className="bg-gradient-to-br from-violet-600 via-purple-600 to-violet-700 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12 text-white text-center">
          <Heart className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 mx-auto mb-4 sm:mb-6" />
          ...
          <Link
            to="/contact"
            className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-white text-violet-600 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl text-sm sm:text-base"
          >
            Get in Touch
          </Link>
        </div>
